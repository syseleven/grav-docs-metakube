...
For easy deployment use our (Metakube External DNS Add-on)[https://docs.syseleven.de/metakube/de/addons/metakube-external-dns]

Copy the following text block into the file `values.yaml`. We need this file to pass our DNS configuration to the helm chart. Please make sure to check all of the fields with the place holder "changeme". You will need to add your OpenStack credentials.
