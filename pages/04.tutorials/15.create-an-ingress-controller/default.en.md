...
The easiest way to install it in your cluster is by installing the fully managed [NGINX Ingress Controller Addon](../../03.addons/01.metakube-ingress/default.en.md).
